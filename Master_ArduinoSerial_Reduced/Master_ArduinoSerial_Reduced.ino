...
/* PIN ASSIGNMENTS */
const byte ECHO_PIN = A0; //TO BE CHANGED 
const byte TRIG_PIN = A1;
const byte door = 2;
const byte IRQ = 3; //Wifi constants
const byte CS_SD = 4;
const byte VBAT = 5;
const byte CS = 10;
...
void html_update(Adafruit_CC3000_ClientRef myclient){
  ...
  myclient.fastrprintln(F("<form method=\"get\">\nAction: <input type=\"text\" name=\"action\" ><br>\n<input type=\"submit\" value=\"Go\">\n</form>\n<p>1 = update status</p>\n<p>2 = arm the system</p>\n<p>3 = turn off alarm</p>\n<p>4 = take a picture with my security camera</p>\n"));
